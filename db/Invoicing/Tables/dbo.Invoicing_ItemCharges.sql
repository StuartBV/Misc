...
GO
ALTER TABLE [dbo].[Invoicing_ItemCharges] ADD CONSTRAINT [PK_INVOICING_ItemCharges] PRIMARY KEY CLUSTERED  ([Id]) WITH (FILLFACTOR=95) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Idx_DeliveryId] ON [dbo].[Invoicing_ItemCharges] ([DeliveryId]) WITH (FILLFACTOR=95) ON [PRIMARY]
GO
...
GO
CREATE NONCLUSTERED INDEX [idx_ItemCharges] ON [dbo].[Invoicing_ItemCharges] ([VatRate], [DeliveryId], [Type], [PriceNet], [PriceGross]) WITH (FILLFACTOR=95) ON [PRIMARY]
GO
