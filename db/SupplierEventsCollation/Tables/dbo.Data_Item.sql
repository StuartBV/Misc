...
GO
ALTER TABLE [dbo].[Data_Item] ADD CONSTRAINT [PK_ItemData] PRIMARY KEY CLUSTERED  ([MessageID], [ID]) WITH (FILLFACTOR=100) ON [Data]
GO
CREATE NONCLUSTERED INDEX [IX_CMS_EventID] ON [dbo].[Data_Item] ([EventID]) WITH (FILLFACTOR=100, PAD_INDEX=ON) ON [Indexes]
GO
CREATE NONCLUSTERED INDEX [IX_ID] ON [dbo].[Data_Item] ([ID]) WITH (FILLFACTOR=100, PAD_INDEX=ON) ON [Indexes]
GO
