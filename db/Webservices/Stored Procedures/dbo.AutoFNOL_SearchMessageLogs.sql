...
CREATE PROCEDURE [dbo].[AutoFNOL_SearchMessageLogs]
...
SELECT ID,createdate,original_message,transformed_message,insuranceclaimno,status,pushedtoppd3,CMS_ClaimID,PDF_Created 
FROM AUTOFNOL_MessageLog
where insuranceclaimno like @searchtxt or CMS_ClaimID like @searchtxt or status like @searchtxt
order by id desc
