...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Report_NU_closed_MI]
@from varchar(10),
@to varchar(10)
as
set nocount on
...
left join ppd3.dbo.GoldsmithsMsgQOutgoing gs on c.OriginClaimID=gs.ClaimID
...
where f.DateClosed between @fd and @td and f.originatingsys='PPD3'
order by f.fin
GO
